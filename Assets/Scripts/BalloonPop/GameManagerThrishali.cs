...
public class GameManagerThrishali : MonoBehaviour
{
    ...
    public void CorrectNumberPopped()
    {
        ...
        ProgressManagerThrishali.Instance.RecordTimeTaken(Time.time - startTime);
    ...
    public void CheckNumber(int number)
    {
        ...
        if (number != TargetNumber)
        {
            ...
            ProgressManagerThrishali.Instance.RecordIncorrectAttempt();
        }
    ...
    {
        ProgressManagerThrishali.Instance.RecordMissedNumber(TargetNumber);
    ...
    void GameOver()
    {
        ...
        ProgressManagerThrishali.Instance.SaveProgress();
    ...
    public void ReplayGame()
    {
        ...
        ProgressManagerThrishali.Instance.StartNewSession();  // Start a new session
    ...
    void ShowProgressDetails()
    {
        ...
        ProgressData currentSession = ProgressManagerThrishali.Instance.progressHistory.allSessions.LastOrDefault();
