...
namespace TracingScripts
{
    public class ButtonHandler : MonoBehaviour
    {
        ...
        {
            Debug.Log($"GoToTracingMainGame method called by: {gameObject.name}");
        ...
        public void GoToTracingMainGame1()
        {
            Debug.Log($"GoToTracingMainGame1 method called by: {gameObject.name}");
            if (!isNextScene && !isPrevScene)
            {
                if (SceneManager.GetActiveScene().name != "TracingMainGame 1") // Updated Scene Name
                {
                    PanelSceneHandler.itemToTrace = myItemToTace;
                    PanelSceneHandler.currentItemTOTrace = myItemToTace;
                }
            ...
            MainMenuHandler.Instance.panelName = "loading";
            MovingToNextScene("TracingMainGame 1"); // Updated Scene Name
        }
